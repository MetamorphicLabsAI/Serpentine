...
const snakeProfiles = [
    ...
    { id: "princess", name: "PRINCESS", lore: "A brindle dachshund protocol. Short legs, long body, infinite loyalty. Features floppy ears and a wagging tail.", head: "#FF8C00", body: "#FF8C00", glow: "rgba(255, 140, 0, 0.8)", food: "#FF3333", foodGlow: "rgba(255, 51, 51, 0.8)", accent: "#FFD700", locked: !unlockedPrincess, unlockCondition: "DECRYPT IN SYSTEM SHOP (50,000 PTS)" }
];
