...
document.getElementById('btn-reset-data').addEventListener('click', () => {
    if (confirm('WARNING: This will permanently erase all saved progress including high scores, unlocks, and bank points. Are you sure?')) {
        const keys = [
            'serpentineHighScore', 'serpentineBank',
            'serpentineUnlockedSpectrum', 'serpentineUnlocked9193',
            'serpentineUnlockedPrincess', 'serpentineUnlockedArthropod',
            'serpentineUnlockedDragon', 'serpentineUnlockedCentipede',
            'bought9193Hint', 'boughtMasterHint',
            'serpentineOpt_princess_playStyle', 'serpentineOpt_arthropod_skin'
        ];
        // Also wipe leaderboards for all difficulties
        ['easy', 'medium', 'hard', 'insane'].forEach(d => {
            keys.push(`serpentineLB_${d}`);
        });
