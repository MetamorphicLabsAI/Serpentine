...
* ⚙️ **Character Options UI**: Advanced profiles (like Princess or Arthropod) now feature a secondary **OPTIONS** layer. Toggle between 'Realistic' and 'Serpentine' play styles for the dog, or cycle through multiple custom skins for the Arthropod. This allows for deep personalization without leaving the arcade dashboard.
